...
import type { AnswerOnCallbackExtra, Client, DeleteMessageExtra, EditMessageExtra, SendMessageExtra, BotCommand, FlattenReq, GetUpdatesDTO, UpdateType } from './core/network/api';
...
export declare class Api {
    ...
    setMyCommands: (commands: BotCommand[]) => Promise<import("./core/network/api").EditMyCommandsResponse>;
    deleteMyCommands: () => Promise<import("./core/network/api").EditMyCommandsResponse>;
